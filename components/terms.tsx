...
const TermsOfUse = () => {
  return (
    <div className="container mx-auto p-10 md:p-32 pt-20 lg:pt-32 py-10 text-justify">
      ...
      <p className="mb-4">
        HUEGO shall not be liable for delays or failures in performance resulting from causes beyond HUEGO&apos;s control, including, without limitation, delays and other problems inherent in the use of the internet and electronic communications. EZYMD is not responsible for any delays, delivery failures, or other damage resulting from such problems.
      ...
      <p className="mb-4">
        HUEGO relies upon pharmacies, pharmaceuticals, and other third-party healthcare providers to provide accurate allergen and adverse effects information, as well as general product safety. HUEGO does not represent or warrant that the information accessible through the service is accurate, complete, reliable, current, or error-free. This includes, without limitation, side effects and allergen information, photos, medicine quality, descriptions, pricing, or reviews.
